struct MyFrame : wxFrame {
    ...
    MyFrame(wxString exename, MyApp *_app)
        ...
        MyAppend(optmenu, wxID_SELECT_FONT, _(L"Font..."),
                 _(L"Set the default font the document text is displayed with"));
        ...
        optmenu->AppendCheckItem(A_HOVERSHADOW, _(L"Hover shadow"),
                                 _(L"Shadow the cell over which the pointer hovers"));
    ...
    void OnMenu(wxCommandEvent &ce) {
        ...
        switch (ce.GetId()) {
            ...
            case A_ADDSCRIPT: {
                wxArrayString fns =
                    GetFilesFromUser(this, _(L"Please select Lobster script file(s):"),

            ...
            case A_REPLACEALL: {
                ...
                if (k == A_REPLACEALL) {
                    ...
                    if(sys->casesensitivesearch) {
                        ...
                        rootgrid->FindReplaceAll(replaces, replaces.Lower());
                    }
                    rootgrid->ResetChildren();
                    Refresh();
                } else {
                    ...
                    if(sys->casesensitivesearch) {
                        selected.g->ReplaceStr(this, replaces, selected);    
                    } else {
                        selected.g->ReplaceStr(this, replaces, replaces.Lower(), selected);
                    }

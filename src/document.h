        ...
        switch (k) {
            ...
            case A_REPLACEALL: {
                ...
                if (k == A_REPLACEALL) {
                    ...
                    rootgrid->FindReplaceAll(replaces, (sys->casesensitivesearch) ? (wxString) wxEmptyString : replaces.Lower());
                    rootgrid->ResetChildren();
                    Refresh();
                } else {
                    loopallcellssel(c, true) if(c->text.IsInSearch()) c->AddUndo(this);
                    selected.g->ReplaceStr(this, replaces, (sys->casesensitivesearch) ? (wxString) wxEmptyString : replaces.Lower(), selected);
